...
A tiny Next.js app that audits a GitHub user's recent public PR sizes in MetaMask Extension and Mobile.
...
- The app fetches recent public PRs for that user in MetaMask Extension and Mobile via GitHub REST APIs.
